...
func TestCoinbaseGetSigningHash(t *testing.T) {
	...
	expectedHash := "0xeff0390caec8827bbdd5aa41d75de330d701fc1c2741a432205bdde787cd3131"
	output := coinbase.GetSigningHash(stateContext.BlockSigningHash())

	if output.String() != expectedHash {
		t.Errorf("expected coinbase signing hash (%v), got (%v)", expectedHash, output.String())
	}
}
...
func TestCoinbaseUnsignedHash(t *testing.T) {
	...
	expectedHash := "0x7ef0387466dc9f64955b73151c59a87d148940b18b67b515fa65691e23469a52"
	output := coinbase.GetUnsignedHash()

	if output.String() != expectedHash {
		t.Errorf("expected coinbase unsigned hash (%v), got (%v)", expectedHash, output.String())
	}
}
